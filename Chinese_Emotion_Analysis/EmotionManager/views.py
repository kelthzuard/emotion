...
import EmotionManager.CEALIB.chinese_emotion_analysis as CEA
from EmotionManager.Modules.main import getScoreFromString
...
def index(request):
    return render(request, 'EmotionManager/index.html', {})
